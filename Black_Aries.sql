...
CREATE TABLE Product_colors (
    ...
    FOREIGN KEY (color_id) REFERENCES Colors(color_id) on update cascade on delete cascade
);
...
INSERT INTO Colors (color_name, color_link) VALUES
   ('Red', '#FF0000'),
   ('Blue', '#0000FF'),
   ('Green', '#008000'),
   ('Black', '#000000'),
   ('White', '#FFFFFF');
    ...
    -- Vortex Dining Table
INSERT INTO Product_colors (quantity, image, price, defaultal, product_id, color_id) VALUES
